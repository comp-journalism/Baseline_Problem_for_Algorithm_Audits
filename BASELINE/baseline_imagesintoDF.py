...
0 remove_rejected_from_data.py
1 index.py
...
data.to_csv("/Users/jenniferstark/Documents/Repositories/googlescraper_images/BASELINE/HC_baseline_hashedDF.csv", index=False)
